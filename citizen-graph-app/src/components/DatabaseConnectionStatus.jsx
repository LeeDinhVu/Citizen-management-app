...
const DatabaseConnectionStatus = () => {
  ...
  const checkConnection = async () => {
    try {
      ...
      // Gọi API backend để check Neo4j connection
  ...
  // Check connection khi component mount
  useEffect(() => {
    checkConnection();
  ...
  return (
    <div style={{ padding: '16px' }}>
      <h2>🗄️ Neo4j Database Connection</h2>
      ...
      {/* Debug Info */}
      <Card title="🔧 Debug Info" style={{ marginTop: '16px', marginBottom: '16px' }}>
